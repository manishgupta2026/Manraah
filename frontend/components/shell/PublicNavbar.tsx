...
export default function PublicNavbar() {
  ...
  return (
    <header className="sticky top-0 z-50 bg-surface/90 backdrop-blur-md border-b border-surface-variant/30 transition-all select-none h-14 sm:h-16 flex items-center">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 w-full flex items-center justify-between">
        ...
        <button
          ...
          className="lg:hidden p-1.5 sm:p-2 rounded-xl bg-surface-container text-on-surface hover:bg-surface-variant/50 transition-colors cursor-pointer"
