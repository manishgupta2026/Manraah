...
export default function ProfileView() {
  ...
  const [userEmail, setUserEmail] = useState("aditi@manraah.com");
  const [userCategory, setUserCategory] = useState("parent");
  ...
  useEffect(() => {
    ...
    if (session?.user) {
      ...
      const rawName = u.name || u.sanctuaryName || "Aditi";
      setUserName(rawName);
      setUserEmail(u.email || "aditi@manraah.com");
      setUserCategory((u.selectedCategory || "parent").toLowerCase());
      if (u.avatar) {
    ...
    fetch("/api/profile")
      ...
      .then((data) => {
        if (data && !data.error) {
          ...
          if (data.category) setUserCategory(data.category.toLowerCase());
  ...
  return (
    <div className="w-full min-w-0 flex flex-col gap-5">
      ...
      <div className="bg-white dark:bg-[#102F27] rounded-3xl p-6 sm:p-7 border border-[#E2ECE6] dark:border-[#23483E] shadow-2xs space-y-5 transition-colors">
        ...
        <div className="flex items-center justify-between">
          ...
          <button
            ...
            type="button"
            className="px-4 py-2 rounded-full bg-[#004D3D] hover:bg-[#003B2E] dark:bg-[#00A982] dark:hover:bg-[#00916F] text-white dark:text-[#071C17] text-xs font-bold shadow-md shadow-[#004D3D]/15 dark:shadow-[#00A982]/15 transition-all flex items-center gap-2 cursor-pointer"
          >
        ...
        <div className="flex flex-col sm:flex-row sm:items-center gap-4.5 pt-1">
          {/* Avatar */}
          <div className="relative shrink-0">
            <div className="w-18 h-18 sm:w-20 sm:h-20 rounded-full overflow-hidden border-3 border-white dark:border-[#14382F] shadow-sm bg-slate-100 dark:bg-[#14382F]">
              <img
                src={userAvatar}
                alt={userName}
            ...
            <div className="absolute bottom-0 right-0 w-4.5 h-4.5 rounded-full bg-[#00A982] border-2 border-white dark:border-[#102F27] flex items-center justify-center text-[9px] text-white font-black shadow-xs">
              ✓
            </div>
          </div>
          ...
          <div className="space-y-1 min-w-0 flex-1">
            <div className="flex items-center gap-2.5 flex-wrap">
              ...
              <span className="px-2.5 py-0.5 rounded-full bg-[#EAF6F0] dark:bg-[#14382F] text-[#006C56] dark:text-[#00A982] text-[10.5px] font-extrabold">
                {formatCategoryLabel(userCategory)}
              </span>
            </div>

            <p className="text-xs text-[#5A756C] dark:text-[#A9C5BC] font-medium leading-relaxed">
              Your wellness journey with Manraah
            </p>

            <div className="flex items-center gap-4 text-[11px] font-medium text-[#789389] dark:text-[#78958C] pt-1">
              <span className="flex items-center gap-1">
                <span>🔥</span>
                <strong className="text-[#19332A] dark:text-[#F4FAF7]">Day {currentStreak}</strong> Streak
              </span>
              <span>•</span>
              <span className="flex items-center gap-1">
                <span>🛡️</span>
      ...
      {/* ===================================================================== */}
      {/* 2. TWO-COLUMN DETAILS GRID: PERSONAL INFO + WELLNESS PREFERENCES      */}
      {/* ===================================================================== */}
      <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
        ...
        <div className="bg-white dark:bg-[#102F27] rounded-3xl p-6 border border-[#E2ECE6] dark:border-[#23483E] shadow-2xs space-y-4 transition-colors">
          <div className="flex items-center gap-2.5 pb-1 border-b border-[#EBF0EC] dark:border-[#23483E]">
            <div className="w-7 h-7 rounded-xl bg-[#EAF6F0] dark:bg-[#14382F] text-[#006C56] dark:text-[#00A982] flex items-center justify-center">
          ...
          <div className="space-y-3.5 text-xs">
            <div>
              <p className="text-[10px] font-bold text-[#789389] dark:text-[#78958C] uppercase tracking-wider">
                Full Name
              </p>
              <p className="text-xs font-bold text-[#19332A] dark:text-[#F4FAF7] mt-0.5">
                {userName}
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-xs font-bold text-[#006C56] dark:text-[#00A982] mt-0.5">
        ...
        <div className="bg-white dark:bg-[#102F27] rounded-3xl p-6 border border-[#E2ECE6] dark:border-[#23483E] shadow-2xs space-y-4 transition-colors">
          ...
          <div className="space-y-3.5 text-xs">
            ...
            <div>
              <p className="text-[10px] font-bold text-[#789389] dark:text-[#78958C] uppercase tracking-wider mb-1.5">
              ...
              <div className="flex flex-wrap gap-1.5">
                {selectedFocusAreas.map((area) => (
                  <span
                    key={area}
                    className="text-[9.5px] font-semibold px-2.5 py-1 rounded-full bg-[#EAF6F0] text-[#006C56] dark:bg-[#14382F] dark:text-[#88F7D6] dark:border dark:border-[#23483E]"
                  >
                    {area}
                  </span>
                ))}
            ...
            <div>
              ...
              <p className="text-xs font-medium text-[#4E685F] dark:text-[#A9C5BC] mt-0.5">
      ...
      {/* ===================================================================== */}
      <div className="bg-white dark:bg-[#102F27] rounded-3xl p-6 border border-[#E2ECE6] dark:border-[#23483E] shadow-2xs space-y-4 transition-colors">
        <div className="flex items-center justify-between pb-1 border-b border-[#EBF0EC] dark:border-[#23483E]">
          ...
          <button
            ...
            type="button"
            className="px-4 py-2 rounded-full border border-red-200 dark:border-red-900/40 text-red-600 dark:text-red-400 hover:bg-red-50 dark:hover:bg-red-950/30 text-xs font-bold transition-colors flex items-center gap-1.5 cursor-pointer disabled:opacity-50"
          >
            <svg className="w-3.5 h-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        ...
        {/* Privacy Notice Card */}
        <div className="p-4 rounded-2xl bg-[#F0F9F5] dark:bg-[#14382F] border border-[#D6EFE2] dark:border-[#23483E] flex items-start gap-3">
