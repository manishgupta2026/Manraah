    ...
    <div className="w-full min-w-0 flex flex-col gap-6">
      ...
      <div className="w-full bg-white dark:bg-[#102F27] rounded-3xl p-6 sm:p-7 border border-[#E2ECE6] dark:border-[#23483E] shadow-2xs transition-colors">
        <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-4 pb-1">
          {/* Left Column: Section Title & Subheading */}
          ...
          <button
            ...
            type="button"
            className="self-start sm:self-auto px-4 py-2 rounded-full bg-[#004D3D] hover:bg-[#003B2E] dark:bg-[#00A982] dark:hover:bg-[#00916F] text-white dark:text-[#071C17] text-xs font-bold shadow-md shadow-[#004D3D]/15 dark:shadow-[#00A982]/15 transition-all flex items-center gap-2 cursor-pointer shrink-0"
          >
        ...
        {/* User Identity Row: Avatar + Details */}
        <div className="flex flex-col sm:flex-row sm:items-center gap-4.5 pt-4 mt-2 border-t border-[#F0F5F2] dark:border-[#1E4339]">
          {/* Avatar with Verified Status Badge */}
          <div className="relative shrink-0">
            <UserAvatar
              user={user}
              sizeClass="w-18 h-18 sm:w-20 sm:h-20 text-xl"
              className="border-3 border-white dark:border-[#14382F] shadow-sm"
            />
            <div className="absolute bottom-0 right-0 w-5 h-5 rounded-full bg-[#006C56] dark:bg-[#00A982] border-2 border-white dark:border-[#102F27] flex items-center justify-center text-[9px] text-white dark:text-[#071C17] font-black shadow-xs">
              ✓
            </div>
          </div>
          ...
          <div className="space-y-1.5 min-w-0 flex-1">
            <div className="flex items-center gap-2.5 flex-wrap">
              <h2 className="text-xl sm:text-2xl font-heading font-black text-[#19332A] dark:text-[#F4FAF7] leading-tight">
                {userName}
              </h2>
            ...
            <div className="flex items-center gap-3.5 text-[11px] font-medium text-[#789389] dark:text-[#78958C] pt-0.5">
